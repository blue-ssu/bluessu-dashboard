  ...
  return (
    <div className="flex items-center justify-center h-screen hero-background">
      <div className="flex flex-col justify-center items-center gap-4">
        <div className="">
          <img src={BlueSSULineWhite} alt="" className="w-[64px] h-[64px]" />
        </div>
        <h1 className="text-center font-bold text-7xl text-white">
          <span className="hero-letter hero-letter-1">B</span>
          <span className="hero-letter hero-letter-2">L</span>
          <span className="hero-letter hero-letter-3">U</span>
          <span className="hero-letter hero-letter-4">E</span>
          <span className="hero-letter hero-letter-5">S</span>
          <span className="hero-letter hero-letter-6">S</span>
          <span className="hero-letter hero-letter-7">U</span>
        </h1>
